...
```r
# getting the songs from the album "what we saw from the cheap seats" from Regina Spektor
regina.whatwesaw<-getAlbum("3Etyu2JmgiQTQztLz6RxDX") #"3Etyu2JmgiQTQztLz6RxDX" is the id for the album.

```

To the features from a specific song:
```r
# getting the song features from "Don't Leave Me [Ne Me Quitte Pas]" from the album "what we saw from the cheap seats" from Regina Spektor
